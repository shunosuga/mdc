...
def create_mock_data():
    ...
    with open(pmc1_dir / "PMC12345.txt", "w") as f:
        f.write(
            "This study presents gene expression data deposited as GSE12345 in the GEO database. "
    ...
    with open(pmc2_dir / "PMC67890.txt", "w") as f:
        f.write(
            "Sequence reads were deposited in SRR123456 repository. "
        ...
        if output_file.exists():
            with open(output_file, "r") as f:
                ...
                if first_line.strip():
                    ...
                    print(
                        f"Original text preview: {sample.get('original_text', '')[:100]}..."
                    )
